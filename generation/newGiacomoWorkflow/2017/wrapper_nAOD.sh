...
#Working on GS step
xrdcp -f root://cmseos.fnal.gov//store/group/lnujj/testGiacomo/${1}.root  SMP-RunIIWinter15pLHE-00016.root
...
xrdcp -f SMP-RunIIFall17NanoAODv7-00268.root root://cmseos.fnal.gov//store/group/lnujj/testGiacomo/nano_${1}.root 
