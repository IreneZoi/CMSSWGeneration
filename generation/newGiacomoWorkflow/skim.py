...
def list_files_xrootd(xrootd_url, directory):
    import subprocess
    result = subprocess.run(['xrdfs', xrootd_url, 'ls', directory], stdout=subprocess.PIPE)
...
def skim(file):
    ...
    xrootd_url = "root://cmsdcache-kit-disk.gridka.de:1094"
...
if __name__ == "__main__":
    ...
    command_file = os.path.join(out_, "hadd_commands.txt")  # File to save commands
